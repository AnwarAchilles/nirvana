...
class RestController extends CI_Controller
{
    ...
    public function __construct($config = 'rest')
    {
        ...
        // $this->lang->load('rest_controller', $language, false, true, __DIR__.'/../'); <-- original code (anwar)
        $this->lang->load('rest_controller', $language, false, true); // <-- modifications (anwar)
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        // $controller_method2 = $this->request->method.'_'.$object_called; // <-- modifications (anwar)
